  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0">
        ...
        <span class="ms-1 font-weight-bold">Admin Chef</span>
      </a>
    </div>
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder text-white mb-0">Tables Chef</h6>
        </nav>
                    ...
                    <tr>
                        ...
                        <td class="align-middle">
                            <div class="d-flex align-items-center">
                                <a href="{{ route('articles.edit', $article->id) }}" class="text-secondary mr-2" data-toggle="tooltip" data-original-title="Edit Artikel">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <form action="{{ route('articles.destroy', $article->id) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="text-secondary" onclick="return confirm('Apakah Anda yakin ingin menghapus Chef ini?')" data-toggle="tooltip" data-original-title="Hapus Artikel">
