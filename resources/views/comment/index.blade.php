  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/argon-dashboard/pages/dashboard.html " target="_blank">
        ...
        <span class="ms-1 font-weight-bold">Admin Komentar User</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="comment">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="ni ni-app text-info text-sm opacity-10"></i>
            </div>
...
<tbody>
    ...
    @else
        ...
        @foreach ($comments as $comment)
            <tr>
                <td>
                    <p class="text-xs font-weight-bold mb-0">{{ $comment->blog_id }}</p>
                </td>
                <td>
                    <p class="text-xs text-secondary mb-0">{{ $comment->content }}</p>
                </td>
                 <td>
                    <p class="text-xs text-secondary mb-0">{{ $comment->name }}</p>
                </td>
                ...
                <td class="align-middle">
                    <form action="{{ route('comment.destroy', $comment->id) }}" method="POST" class="d-inline">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="text-secondary font-weight-bold text-xs" onclick="return confirm('Apakah Anda yakin ingin menghapus Komentar ini?')" data-toggle="tooltip" data-original-title="Hapus Artikel">
                            Hapus
                        </button>
                    </form>
                </td>
